# <img src="https://raw.githubusercontent.com/multiverseweb/Eclipse/main/src/icons/eclipse.png" height="30px" id="project-logo"> Eclipse
...
1. Download `Eclipse.zip` from [this link](https://github.com/multiverseweb/Eclipse/raw/refs/heads/main/Eclipse.zip).
...
To add a new theme, edit `src/themes.json`. See the [Contributing Guide](CONTRIBUTING.md) for instructions.
